...
export APP_NAME='jx-build-controller'
...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-build-controller/main/26'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-build-controller:0.5.18'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='ghcr.io'
export REPO_NAME='jx-build-controller'
