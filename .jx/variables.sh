...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-build-controller/main/10'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-build-controller:0.3.19'
