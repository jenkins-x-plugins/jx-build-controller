...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/jx-build-controller/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-build-controller:0.3.0'
