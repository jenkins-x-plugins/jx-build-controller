...
require (
	...
	github.com/jenkins-x-plugins/jx-pipeline v0.1.41
...
require (
	...
	github.com/jenkins-x-plugins/jx-gitops v0.7.7 // indirect
	github.com/jenkins-x/go-scm v1.11.5 // indirect
	github.com/jenkins-x/lighthouse-client v0.0.448 // indirect
