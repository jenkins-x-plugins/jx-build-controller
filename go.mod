...
require (
	...
	github.com/jenkins-x-plugins/jx-pipeline v0.1.16
	github.com/jenkins-x-plugins/jx-secret v0.1.64
	github.com/jenkins-x/jx-api/v4 v4.3.3
	github.com/jenkins-x/jx-helpers/v3 v3.2.3
	github.com/jenkins-x/jx-kube-client/v3 v3.0.2
	github.com/jenkins-x/jx-logging/v3 v3.0.6
	github.com/jenkins-x/lighthouse-client v0.0.412 // indirect
