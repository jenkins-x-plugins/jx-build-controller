...
require (
	...
	github.com/jenkins-x-plugins/jx-pipeline v0.1.22
	github.com/jenkins-x-plugins/jx-secret v0.1.66
	github.com/jenkins-x/jx-api/v4 v4.3.4
	github.com/jenkins-x/jx-helpers/v3 v3.2.5
	github.com/jenkins-x/jx-kube-client/v3 v3.0.2
	github.com/jenkins-x/jx-logging/v3 v3.0.6
	github.com/jenkins-x/lighthouse-client v0.0.433 // indirect
